const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AgentStore-VJOuVihz.js","assets/AgentPanel-Bb05Vymr.js","assets/editor.api-D7OB3-Nf.js","assets/editor-DYpEHO_6.css","assets/preload-helper-8MtV_aQO.js","assets/ToastManager-Db86LBLx.js","assets/index-BCDVt3Gd.js","assets/index-AJxxvGoq.css"])))=>i.map(i=>d[i]);
...
\`\`\`json
`+JSON.stringify(r,null,2)+"\n```\n\n---\n*Nota para el Curador (Mortymerio): Revisa los prompts y las herramientas solicitadas antes de copiar este JSON en `public/agents_registry.json`.*"),a=this.repoIssuesUrl+`/new?title=`+n+`&body=`+i+`&labels=agent-submission`;window.open(a,`_blank`)},async getIssueData(e){if(!e)return{votes:0,comments:0};try{let t=await fetch(this.repoApiUrl+`/issues/`+e);if(!t.ok)return{votes:0,comments:0};let n=await t.json();return{votes:n.reactions?n.reactions[`+1`]:0,comments:n.comments||0}}catch{return{votes:0,comments:0}}},async render(e,t){e.innerHTML=``;let n=document.createElement(`div`);n.style.cssText=`padding: 15px; border-bottom: 1px solid #30363d; background: #0d1117;`,n.innerHTML=`
