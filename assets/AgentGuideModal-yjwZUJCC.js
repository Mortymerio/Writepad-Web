import{r as e}from"./index-BCDVt3Gd.js";var t={show(){let t=document.getElementById(`agent-guide-modal`);t||(t=document.createElement(`div`),t.id=`agent-guide-modal`,t.className=`modal-overlay`,t.style.display=`none`,t.innerHTML=`
