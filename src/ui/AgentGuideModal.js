...
export const AgentGuideModal = {
  show() {
    let modal = document.getElementById('agent-guide-modal');
    if (!modal) {
      modal = document.createElement('div');
      modal.id = 'agent-guide-modal';
      ...
      document.getElementById('btn-close-agent-guide').onclick = () => {
        modal.style.display = 'none';
      };
    ...
    const content = document.getElementById('agent-guide-content-md');
    
    content.innerHTML = marked.parse(this.getGuideMarkdown());
    
    if (!document.getElementById('agent-md-style')) {
      const style = document.createElement('style');
      style.id = 'agent-md-style';
      style.innerHTML = `
