export const CommunityDisclaimerModal = {
  show(onAccept) {
    let modal = document.getElementById('community-disclaimer-modal');
    if (!modal) {
      modal = document.createElement('div');
      modal.id = 'community-disclaimer-modal';
      ...
      document.getElementById('btn-cancel-disclaimer').onclick = () => {
        modal.style.display = 'none';
      };
      
      document.getElementById('btn-accept-disclaimer').onclick = () => {
        localStorage.setItem('community_disclaimer_accepted', 'true');
        modal.style.display = 'none';
